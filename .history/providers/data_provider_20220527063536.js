...
const projectsData = {
  // these are checked when someone goes dorecly to /app_name
  valid_apps: ["ahadith-Collection", "al-Qur'an"],
  // **************************************
  //    current projects
  //   ***********************************
  current_projects: [
  ...
  completed_projects: [
    {
      ...
      app_description: (
        ...
        >
          ...
          provider for you Grade if available for a particular hadith.
          <br></br>
          <br></br>
          The App is very basic, simple and very straight forward to use.
          Features the Hadiths in 3 languages ( English /urdu / arabic ). The
          information about the hadith has been give right below the hadith. The
          App also features the last Read to help you continue where you left
          reading. There is also an option for Theme selection Just choose the
          theme according to your needs.<br></br>
          <br></br>
          ...
          are also available in the App. PLease go thorught the Video of the app
          in order to get the overview of the app. And indeed the best way is to
          just the download the app yourself and discover the features yourself.
          <br></br>
      ...
      photo_links: [
        "https://play-lh.googleusercontent.com/wwTcB1EIa68P28mjcNiBxoO3IT4n7svk_6pEUf6h5NR3lulpWwR0Y60JkIBTPcUGlo87=w1052-h592-rw",
        "https://play-lh.googleusercontent.com/oVM5Byq5Ana0a_iuRlP1buNquG9tpyw65KKBxGl2wsMwe5ChunHkbHd6rlbj-nH2cg=w1052-h592-rw",

        "https://play-lh.googleusercontent.com/gmptnsxADWQtQs0KNZKkoXrs6LqdNRnrAyV4LbUqbnXTyJqlCB5iaSdFiKIlZDAy-7fc=w1052-h592-rw",

        "https://play-lh.googleusercontent.com/M6yhgh1lwiZDsLrgk_62X2lo9ww6SiIYppwOsGGZJx7sAWqgiYJ2k9SZgHL11_nm_yc=w1052-h592-rw",

        "https://play-lh.googleusercontent.com/3Q3dnTk1JAeYA0iaFz0dXZlgVdPuasHZaFoXayKAWqK4UrLsHGhbzidYF6kTdio5XgI=w1052-h592-rw",
    ...
    // al Qur'an
    {
      ...
      app_description: (
        ...
        >
          ...
          app features Qur'an translation is 44 world wide Languages, 50+
          reciter choices, and the tafsirs, the App also features the favourites
          section where you can easily collect the verses of the qur'an which
          ever you want. The most important feature is of Last Read ! Well the
          app alhamdulillah has it in the easieast possible way. Just select a
          verse where you want to stop reading and inshallah app will open the
          very verse where you left off when you click on the Last Read Icon.
          <br></br>
          ...
          features i haven't meantioned here, well u can watch the launch video
          to know more. And the best way is to download the App and discover
          them yourself. Well You can watch the Video of the App from the Video
          section ! See Up next to Discription and inshallah you will know
          majority of the features the app offers.And inshallah We hope you'll
          enjoy the app.
        </h3>
      ),

    ...
    completed: [
      {
        "ahadith-Collection": {
          ...
          app_description: (
            ...
            >
              IMPORTANT<br></br>
              Alhamdulillah The App contains majority of the available sahih
              hadith but it also contains some of the daif / hasan hadiths, So
              we have provider for you Grade if available for a particular
              hadith.
              <br></br>
              <br></br>
              The App is very basic, simple and very straight forward to use.
              Features the Hadiths in 3 languages ( English /urdu / arabic ).
              The information about the hadith has been give right below the
              hadith. The App also features the last Read to help you continue
              where you left reading. There is also an option for Theme
              selection Just choose the theme according to your needs.<br></br>
              <br></br>
              Contacting portals have been provided to you in order to reach to
              us in case you need any help. Many other features are also present
              like if if you want to copy a hadith you can easliy do it, you can
              also easily share any hadith to any platform you want. Some more
              features are also available in the App. PLease go thorught the
              Video of the app in order to get the overview of the app. And
              indeed the best way is to just the download the app yourself and
              discover the features yourself.
              <br></br>
              The App is availble completely free on Google Play. We hope
              inshallah you'll enjoy the App.
            </h3>
          ),
          photo_links: [
      ...
      // al Qur'an privacy policy
      {
        "al-Qur'an": {
          ...
          app_description: (
            ...
            >
              al Qur'an is a free, simple and easy to use application that helps
              you learn the Qur'an. We tried our best alhmdulillah to provide
              the reader the most comfortable experience possible and we have
              also designed the app interface not only for youth but also for
              older people who don't have much experience with the new complex
              apps. O ! Younger ones teach the elder ones how to use the app and
              be humble to them, inshallah you'll find them to be Quick
              Learners.<br></br>
              <br></br>Alhmadulillah the app is completely free to download from
              the Play Store. The App has alot of features won't be possible to
              describe all of them here, but we'll list a few. For example
              alhamdulillah the app features Qur'an translation is 44 world wide
              Languages, 50+ reciter choices, and the tafsirs, the App also
              features the favourites section where you can easily collect the
              verses of the qur'an which ever you want. The most important
              feature is of Last Read ! Well the app alhamdulillah has it in the
              easieast possible way. Just select a verse where you want to stop
              reading and inshallah app will open the very verse where you left
              off when you click on the Last Read Icon.<br></br>
              <br></br> Well i got carried away and the description is going
              quite long, you'll be bored reading ! Its most fun to watch the
              video and get a quick overview of the app and there are alot more
              quality features i haven't meantioned here, well u can watch the
              launch video to know more. And the best way is to download the App
              and discover them yourself. Well You can watch the Video of the
              App from the Video section ! See Up next to Discription and
              inshallah you will know majority of the features the app
              offers.And inshallah We hope you'll enjoy the app.
            </h3>
          ),
    ...
    current_projects: [
      {
        ...
        project_title: "ahadith Collection",
      },
    ],

    futute_projects: [
      {
        project_background_color: "not_specified_yet",
        project_description:
      ...
      },
      {
        ...
        project_image_url:
          "https://firebasestorage.googleapis.com/v0/b/se-portfolio-db.appspot.com/o/android_studio_icon.png?alt=media&token=89e2d4f9-0e42-477b-a3a3-2bc81e91bd60",
        project_title: "Qur'anic Arabic Course App",
      },
    ],
  };

      ...
      "ahadith-Collection": {
        ...
        app_description: (
          ...
          >
            ...
            hadith but it also contains some of the daif / hasan hadiths, So we
            have provider for you Grade if available for a particular hadith.
            <br></br>
            <br></br>
            The App is very basic, simple and very straight forward to use.
            Features the Hadiths in 3 languages ( English /urdu / arabic ). The
            information about the hadith has been give right below the hadith.
            The App also features the last Read to help you continue where you
            left reading. There is also an option for Theme selection Just
            choose the theme according to your needs.<br></br>
            <br></br>
            Contacting portals have been provided to you in order to reach to us
            in case you need any help. Many other features are also present like
            if if you want to copy a hadith you can easliy do it, you can also
            easily share any hadith to any platform you want. Some more features
            are also available in the App. PLease go thorught the Video of the
            app in order to get the overview of the app. And indeed the best way
            is to just the download the app yourself and discover the features
            yourself.
            <br></br>
      ...
      "al-Qur'an": {
        ...
        app_description: (
          ...
          >
            ...
            you learn the Qur'an. We tried our best alhmdulillah to provide the
            reader the most comfortable experience possible and we have also
            designed the app interface not only for youth but also for older
            people who don't have much experience with the new complex apps. O !
            Younger ones teach the elder ones how to use the app and be humble
            to them, inshallah you'll find them to be Quick Learners.<br></br>
            ...
            verses of the qur'an which ever you want. The most important feature
            is of Last Read ! Well the app alhamdulillah has it in the easieast
            possible way. Just select a verse where you want to stop reading and
            inshallah app will open the very verse where you left off when you
            click on the Last Read Icon.<br></br>
            <br></br> Well i got carried away and the description is going quite
            long, you'll be bored reading ! Its most fun to watch the video and
            get a quick overview of the app and there are alot more quality
            features i haven't meantioned here, well u can watch the launch
            video to know more. And the best way is to download the App and
            discover them yourself. Well You can watch the Video of the App from
            the Video section ! See Up next to Discription and inshallah you
            will know majority of the features the app offers.And inshallah We

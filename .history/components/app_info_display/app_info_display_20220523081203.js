...
const AppsInformation = {
  ...
  "al-Qur'an": {
    ...
    app_description:
      "Al Quran is a free, simple and easy to use application that helps you learn the Qur'an. We tried out best to provide the reader the most comgfortable experience possible.\n`Alhmadulillah the app is completely free to download from the Play Store, We hope you enjoy the app.",

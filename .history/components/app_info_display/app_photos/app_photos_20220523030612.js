  ...
  return (
    <div>
      <div className={styles.app_photos_container}>
        <div>
          <img style={{}} className={styles.slides} src={photoLinks[0]}></img>   </div>
          <div>  <img style={{}} className={styles.slides} src={photoLinks[1]}></img>   </div>
          <div>  <img style={{}} className={styles.slides} src={photoLinks[2]}></img>   </div>
        </div>
      </div>
    </div>
  );

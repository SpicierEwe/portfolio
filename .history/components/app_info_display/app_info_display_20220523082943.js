  ...
  "al-Qur'an": {
    ...
    app_description: (
      <h3 className={styles.description}>
        ...
        quality features i haven't meantioned You can watch the Video of the App
        from the Video Title and inshallah you will know majority of the
        features the app offers. We hope you enjoy the app.
      </h3>
    ),

            ...
            <div className={styles.main_container}>
              <div>
                <div className={styles.section_1_flex}>
                  ...
                  >
                    <img src={AppsInformation[appName]["logo_link"]}></img>
                  </div>
  ...
  "al-Qur'an": {
    ...
    app_description: (
      <h3 className={styles.description}>
        ...
        learn the Qur'an. We tried out best to provide the reader the most
        comfortable experience possible.<br></br>Alhmadulillah the app is
        completely free to download from the Play Store. The App has alot of
        features wont be possible to discribe all of them, but we'll list a few.
        For example alhamdulillah the app features Qur'an translation is 44
        world wide Languages, 50+ reciter choices, and the tafsirs,The App also
        features the favourites section where you can easily collect the verses
        of the qur'an which ever you want. The most important feature is of Last
        Read ! Well the app alhamdulillah has it in the easieast possible way.
        JUst select a verse for kast read and inshallah app will open that verse
        where you left off when you click on the Last Read Icon.<br></br>
        <br></br>. Well i carried on the descriptionis going quite long, you'll
        be bored reading ! Its most full to watch the video and know abut more
        there are mre quality features i haven't meantioned here, well u can
        watch the launch video to know more. And the best way is to download the
        App and discover them yourself. Well You can watch the Video of the App
        from the Video section ! See Up next to Discription and inshallah you
        will know majority of the features the app offers. We hope you enjoy the
        app.
      </h3>
    ),

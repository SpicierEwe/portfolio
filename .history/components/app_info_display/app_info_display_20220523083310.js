  ...
  "al-Qur'an": {
    ...
    app_description: (
      <h3 className={styles.description}>
        ...
        the most comfortable experience possible also specially for old people
        who don;t have much experience with the new complex apps.<br></br>
        <br></br>Alhmadulillah the app is completely free to download from the
        Play Store. The App has alot of features wont be possible to discribe
        all of them, but we'll list a few. For example alhamdulillah the app
        features Qur'an translation is 44 world wide Languages, 50+ reciter
        ...
        for kast read and inshallah app will open that verse where you left off
        when you click on the Last Read Icon.<br></br>

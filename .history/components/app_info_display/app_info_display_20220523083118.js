  ...
  "al-Qur'an": {
    ...
    app_description: (
      <h3 className={styles.description}>
        ...
        where you left off when you click on the Last Read Icon.<br></br>. Well
        i carried on the descriptionis going quite long, you'll be bored reading
        ! Its most full to watch the video and know abut more there are mre
        quality features i haven't meantioned here, well u can watch the launch
        video to know more. And the best way is to download the App and discover
        ...
        majority of the features the app offers. We hope you enjoy the app.
      </h3>
    ),

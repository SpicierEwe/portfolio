  ...
  "ahadith-Collection": {
    ...
    app_description: (
      <h3 className={styles.description}>
        ...
        <br></br>
        Alot of contacting portals has been provided to you in order to reach to
        us in case you need any help. Many other features are also preset like
        if if you want to copy a hadith you can easliy do it, you can also
        easily share any hadith to ant platform you want. Some more features are
        also available in the App.PLease go thorught the video of the app in
        order to get the over view of the app. And indeed the best app is to
        just the downoad the app and discover the features youself. We hope
        inshall h you enjoy the App
      </h3>
    ),
    photo_links: [

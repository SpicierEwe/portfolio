  ...
  "al-Qur'an": {
    ...
    policies: [
      ...
      },
      {
        ...
        description:
          "The App is Completely OFFLINE but the need of INTERNET is because of the audio files. Streaming audio files takes much less time and internet these days . I've kept the audio PLAYABLE only by INTERNET because it was impossible to supply them offline cause of VAST MAJORITY of RECITER CHOICES. And you also neet internet in order to download the audio files, and alse to be able to contact to us through contacting PORTALS.",
      },
      {

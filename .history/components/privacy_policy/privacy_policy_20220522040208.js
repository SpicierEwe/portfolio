...
const ahadithCollection = (
  <div>
    ...
    Google Firebase Analytics This Qur'an app using Google Firebase Analytics
    (one of Google's products) to collect information, such as: device model,
    operating system version and what features are often opened in this
    application. We use this information so that we know the user experience in
    this application, so that this application can be even better in the next
    update. You should know, almost all applications in the Google Play Store
    and Apple Store use Google Firebase Analytics. Google Firebase

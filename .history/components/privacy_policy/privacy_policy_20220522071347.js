  ...
  "al-Qur'an": {
    ...
    policies: [
      ...
      },
      {
        title: "Regarding your Private Information",
        description:
          "We Do not Collect Any of Your Data either Knowingly rr unknowingly, and why would we ? I haven't created this app to ruin myself ON the Day of Judgement but rather to be close to my Lord The Most High (Alahuakabar) , May Allah (The Almighty) Forgive us all and admit us all to Jannatul Firdausi al aala.",
      },
      {
        title: "Changes To This Privacy Policy",
        description:

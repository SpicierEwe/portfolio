...
import CustomTitleWidget from "../project_page/custom_widgets/project_category_widget/custom_title_widget";
  ...
  "al-Qur'an": {
    ...
    policies: [
      ...
      },
      {
        ...
        description:
          "The App is Completely OFFLINE but the need of INTERNET is because of the audio files. Streaming audio files takes much less time and internet these days . I've kept the audio PLAYABLE only by INTERNET because it was impossible to supply them offline cause of VAST MAJORITY of RECITER CHOICES. And you also need internet in order to download the audio files, and to be able to contact to us through contacting PORTALS.",
      },
      {
      ...
      },
      {
        title: "Regarding your Private Information",
        description:
          "We Do not Collect Any of Your Data either Knowingly Or unknowingly. And Why Would WE ? I haven't created this APP to ruin myself ON the Day OF Judgement but rather to be close to my Lord THE MOST HIGH (ALLAHUAKBAR) , May Allah (The Almighty) Forgive us all and admit us all to JANNATUL FIRDAUSI AL AALA.",
      },
      {
        title: "Changes To This Privacy Policy",
        description:
          "This Privacy Policy is effective as of 22 May, 2022and will remain in effect except with respect to any changes in its provisions in the future, which will be in effect immediately after being posted on this page.We reserve the right to update or change our Privacy Policy at any time and you should check this Privacy Policy periodically. If we make any material changes to this Privacy Policy, we will notify you by placing a prominent notice on our website and also in the App..",
      },
      {
        title: "Contact Information",
        description:

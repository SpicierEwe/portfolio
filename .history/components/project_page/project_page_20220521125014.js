        ...
        <div className={styles.content_flex}>
          ...
          */}
          ...
          <div className={styles.right}>
            <section className={styles.section_project_text_box}>
              <div>
                <h2 className={styles.title}>My Projects</h2>
                <p className={styles.dis}>
                  Here are some of my projects. The Current ones, The Completed
                  ones and inshallah the Future ones.<br></br>_text_boxi&apos;m
                  always open to new ideas contact me if you have any.
                </p>
              </div>
            </section>
          </div>

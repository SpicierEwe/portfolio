            ...
            <section className={styles.section_project_intro_text_box}>
              <div>
                ...
                <p className={styles.dis}>
                  Here are some of my projects on which i worked on.<br></br>{" "}
                  The Current ones, The Completed ones and inshallah the Future
                  ones.
                  <br></br>
                  i&apos;m Alhamduliah always open to new Ideas Contact me if
                  you have any.
                </p>
              </div>
            </section>

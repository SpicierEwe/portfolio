            ...
            {completed.map((completedProjectInfo, index) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <img src={completedProjectInfo["logo_link"]}></img>
                    {/*
                  ...
                  <div className={styles.project_description_box}>
                    ...
                    <button
                      onClick={() => {
                        if (completedProjectInfo["download_link"] != "#") {
                          window.open(
                            completedProjectInfo["download_link"],
                            "_blank"
                          );
                        }
                      }}
                      onMouseOver={() => {
                        ...
                        changeBackground(
                          event,
                          completedProjectInfo["background_color"]
                        );
                      }}
                      onMouseLeave={() => {

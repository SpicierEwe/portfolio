...
function Current(props) {
  ...
  var project_dis = data["project_title"];
  var project_image = data["project_title"];
  var ongoing_status = data["project_title"];
  var project_progress_percentage = data["project_title"];
  return (
    <div>

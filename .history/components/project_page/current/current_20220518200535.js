    ...
    <div>
      <section className={styles.section}>
        <div className={styles.left}>
          ...
          {/* progress  */}
          <project_status_box status_title="Completion"></project_status_box>
        </div>
        {/* right */}
...
function project_status_box({ status_title, status_value }) {
  return (
    <div>
      <p style={"background: 'red'"}>{status_title}</p>
      <p>{status_value}</p>
    </div>
  );
}
